  ...
  return (
    <nav className="bg-gray-300 h-14">
      <div className="flex items-center justify-between h-14">
        <div className="flex">
          <h4 className="text-2xl font-bold ml-2 text-blue-500"><span className="text-3xl text-gray-600">R</span>edux-<span className="text-3xl text-gray-600">T</span>oolkit</h4>
          <ul className="flex items-center gap-4 ml-4">
            <li className="">Create Post</li>
            <li className="">All Post</li>
          </ul>
        </div>
        <input
